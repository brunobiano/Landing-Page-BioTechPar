...
export const TopMenu = () => {
    return (
        <C.Container>
            ...
            <a href="mailto:evandro@biotechpar.com.br"><img src={mailIcon} alt="" width='12px'/>evandro@biotechpar.com.br</a>
            <a href="https://wa.me/5541992881987"><img src={whatsIcon2} alt="" width='12px'/></a>
